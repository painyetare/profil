...
function AwardsSection() {
    ...
    const data = [
        {
            title: 'Awwwards',
            count: 'x2',
            award: 'Site of the Day - PainyDev',
            date: '08-31-2023',
            award1: 'Developer Award - PainyDev',
            date1: '08-31-2023'
        },
        {
            title: 'The FWA',
            count: 'x1',
            award: 'FWA of the Day - PainyDev',
            date: '08-19-2023',
        },
        {
            title: 'CSSDA',
            count: 'x1',
            award: 'Website of the Day - PainyDev',
            date: '04-10-2023',
        },
    ]
    ...
    useGSAP(() => {
        ...
        tl.from('.rightAwardSecondDiv h4, p, h6', {
            y: 100,
            opacity: 0,
            duration: 1,
            ease: 'power4.in'
                            ...
                            <div key={index} className='sm:mb-[2vw] mb-[12vw]'>
                                ...
                                {item.award1 && (
                                    <div  className='flex  items-end  justify-between mb-[12vw] sm:mb-[2.5vw] space-y-[6vw] sm:space-y-[1.2vw]'>
                                        ...
                                        <div className='overflow-hidden'><h6 className='text-[4.2vw] sm:text-[1.2vw]'>{item.date1}</h6></div>
                                    </div>
                                )}
                            </div>
                        )
